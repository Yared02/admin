...
function ListStudent() {
  ...
  const deletePost = (id) => {
    ...
    axios.delete(`http://localhost:8080/api/stud/delete/${id}`)
...
const onClickDelete=(id)=>{
     axios.delete(`http://localhost:8080/api/stud/delete-applicant/${id}`)
     .then((res=>{
          ...
          <tbody>
            ...
            {applicants.map((data, i) => (
              <tr key={data._id}>
                ...
                <td>{data.raddres}</td>
                <td>{data.cenrollement}</td>
                <td>{data.cschedule}</td>
                <td>{data.sdate}</td>
                <td>{data.edate}</td>
